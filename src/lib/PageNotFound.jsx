                ...
                <div className="text-center space-y-6">
                    ...
                    <div className="pt-6">
                        <button 
                            ...
                            className="inline-flex items-center px-6 py-2.5 text-sm font-body font-medium text-primary-foreground bg-primary rounded-sm hover:opacity-90 transition-opacity"
                        >
