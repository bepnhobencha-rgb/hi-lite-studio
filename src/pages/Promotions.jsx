  ...
  return (
    <div>
      ...
      <section className="relative h-[380px] md:h-[460px] flex items-end overflow-hidden">
        <img
          src={IMAGES.groupClients}
          alt="Happy clients celebrating at Hi-Lite Studio"
            ...
            {PROMOTIONS.map((promo, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white border border-[#ede8e0] rounded-2xl p-12 flex flex-col shadow-[0_2px_20px_rgba(212,185,150,0.08)] hover:shadow-[0_8px_36px_rgba(212,185,150,0.18)] transition-all duration-500 hover:-translate-y-1"
                >
                  <div className="inline-flex items-center justify-center w-14 h-14 rounded-full mb-7" style={{ background: "linear-gradient(135deg, #faf6f0, #f3ece1)" }}>
                    <Icon size={24} strokeWidth={1.3} style={{ color: "#C2A57F" }} />
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-6 border-t border-[#ede8e0]">
                    <span className="font-heading text-2xl font-light" style={{ color: "#C2A57F" }}>
                      {promo.detail}
                    </span>
                    <a
                      href={BOOKING_URL}
                      ...
                      style={{
                        ...
                        color: "#fff",
                        boxShadow: "0 4px 16px rgba(212,185,150,0.38)",
                      }}
                      onMouseOver={e => { e.currentTarget.style.boxShadow = "0 8px 24px rgba(212,185,150,0.55)"; e.currentTarget.style.transform = "translateY(-1px)"; }}
                      onMouseOut={e => { e.currentTarget.style.boxShadow = "0 4px 16px rgba(212,185,150,0.38)"; e.currentTarget.style.transform = "translateY(0)"; }}
                    >
                      Book Now
                    </a>
                  </div>
